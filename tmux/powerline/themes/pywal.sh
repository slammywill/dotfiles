...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$color1}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
    ...
    "tmux_session_info $color3 $background"
		...
		#"pwd $red $black"
    #"battery $red $black"
		#"tmux_mem_cpu_load $color4 $foreground ${TMUX_POWERLINE_RIGHT_SEPARATOR_BOLD}"
		#"lan_ip 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"vpn 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		#"wan_ip $green $black"
		#"vcs_branch $blue $black"
		#"vcs_compare 60 255"
		#"vcs_staged 64 255"
		#"vcs_modified 9 255"
		#"vcs_others 245 0"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		#"date_day $color3 $foreground"
		#"date $color3 $foreground ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		#"time $color3 $foreground ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
	)
fi
